...
A kisvilág szerkezet, amit már  Karinthy is megsejtett 1929-es
  novellájában, meglepőnek tűnhet, de Erdős--Rényi-féle véletlen grafikonokban
    ...
    megsejtett 6, de ez a hálózat irányítottságának köszönhető.
...
\subsection{Skálafüggetlenség} 
  A sklálafüggetlen gráfok definiáló tulajdonsága, hogy a fokszámok
    ...
    súlyösszege egyaránt megegyezik a szónak a korpuszban
    való gyakoriságával.
    Az elméletileg garantált tulajdonságot statisztikailag is ellenőriztük.
    A fokszámeloszlást exponenciális eloszlással összehasonlítva 133-as
...
%    Kiszámoltuk a \emph{széleket} (periphery) is, de az nx.diameter (G, stb_d) A _center_ nx.center (G, stb_d) A __ periféria olyan csomópontok halmaza, amelyeknek az átmérője azonos az excentricitással: nx periféria (G, stb_d) 
