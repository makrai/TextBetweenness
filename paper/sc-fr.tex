...
%J    Kiszámoltuk a \emph{széleket} (periphery) is, de az nx.diameter (G, stb_d) A _center_ nx.center (G, stb_d) A __ periféria olyan csomópontok halmaza, amelyeknek az átmérője azonos az excentricitással: nx periféria (G, stb_d) 
...
\includegraphics[width=25cm]{current-flow-closeness.png}
  2.\ ábra. A szavak eloszlása \emph{closeness centrality} szerint. %}
\end{center}
  %\caption{
\label{fig:closeness}
\end{sidewaysfigure}
...
%\caption{
  3.\ ábra. A HITS algoritmus eredménye.
